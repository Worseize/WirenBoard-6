...
4) Troubleshoot
Rules.js has in protocol time that equal 0001 in hex format meaning 1 second , but in reality I got many times error when trying to make channel off with that time , soo change time to 0002 if you got same error. I think it could be soo because we have wrong crc table probably or just channels can`t set off soo quickly it does not matter why because we have solution on that problem. 
