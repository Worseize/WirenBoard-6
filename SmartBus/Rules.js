...
function Pack_crc(dataString) {
  var crc;
  var dat;
  crc = 0;
  for (var pos = 0; pos < dataString.length; pos += 2) {
    dat = crc >> 8;
    crc <<= 8;
    crc &= 0xFFFF; // <- mask result to 16 bits
    crc ^= CRC_TAB[dat ^ parseInt(dataString.substr(pos, 2), 16)];
  }
...
/***Create virtual bus for sending controls***/
...
/***While we got updates on control bus send that data to linux bash script***/
...
defineRule("hdl_incoming", {
  ...
  then: function(newValue, devName, cellName) {
    runShellCommand('bash /var/udp/smartbusControl.sh ' +newValue);
  }
});
...
/***If we got data from bus then we decode it and send decoded data to Wirenboard MQTT channels***/
/**Decoding based on smartbus protocol**/
...
/***Prototype rule for creating channels that move data from MQTT Controls to virtual control bus based on smartbus protocol***/
function makeRules(channelName, hexChannel, decDeviceAddress, hexDeviceAddress, hexTime){
...
/***Smartbus control channels***/
makeRules("Channel1", "01", "0131", "011F", "0001");
makeRules("Channel2", "02", "0131", "011F", "0001");
makeRules("Channel3", "03", "0131", "011F", "0001");
makeRules("Channel4", "04", "0131", "011F", "0001");
makeRules("Channel5", "05", "0131", "011F", "0001");
makeRules("Channel6", "06", "0131", "011F", "0001");

makeRules("Channel1", "01", "0132", "0120", "0001");
makeRules("Channel2", "02", "0132", "0120", "0001");
makeRules("Channel3", "03", "0132", "0120", "0001");
makeRules("Channel4", "04", "0132", "0120", "0001");
makeRules("Channel5", "05", "0132", "0120", "0001");
makeRules("Channel6", "06", "0132", "0120", "0001");
makeRules("Channel7", "07", "0132", "0120", "0001");
makeRules("Channel8", "08", "0132", "0120", "0001");
makeRules("Channel9", "09", "0132", "0120", "0001");
makeRules("Channel10", "0A", "0132", "0120", "0001");
makeRules("Channel11", "0B", "0132", "0120", "0002"); //hextime 0002
makeRules("Channel12", "0C", "0132", "0120", "0001");

makeRules("Channel1", "01", "0133", "0121", "0001");
makeRules("Channel2", "02", "0133", "0121", "0001");
makeRules("Channel3", "03", "0133", "0121", "0001");
makeRules("Channel4", "04", "0133", "0121", "0001");
